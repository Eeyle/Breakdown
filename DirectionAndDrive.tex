...
\begin{tabular}[c]{@{}r@{}}relative\\velocities\end{tabular} & The enemies are orbiting in the opposite direction as the friendly ships around the moon. This means the ships will get close to each other very quickly and will pass each other at enormous speeds. \\ 
...
\midrule
Enemy Description :- \\
The player's home station has identified them as a threat. The home station fires weaponry which causes most of the problems, while the entire planet below launches its defenses. These planetary defenses include only missiles. \newline When each missile takes a railgun or ray shot, \newline \qeq{1d4}{1-2.}{The hole or dent does little to nothing.}{3.}{The hole or dent disables the targeting and guidance systems, putting the rocket dead in the water.}{4.}{The hole or dent sets off the ignition system, instantly exploding the rocket.}{}{} \\
\midrule
Reason for Engagement :- \\
