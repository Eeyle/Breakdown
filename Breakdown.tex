...
\subsection{Weaponry Development}

This campaign assumes that railguns and ray accelerators have become the dominant forms of weaponry aboard spaceships. The following section is a brief description of the back-and-forth of early space combat that led to this situation.

When space travel first began, combat ships were equipped with traditional gunpowder weaponry. These fell out of fashion as it became apparent that speed, accuracy, and impact energy were lacking for these. Some large early vessels used naval cannons which improved speed and energy, but these fell out of use as concerns were raised about leftover smoke and the safety of storing ammunition.

The railgun quickly outclassed any naval cannons. It had a smaller size, safer ammunition, a much cheaper cost per shot, and a higher accuracy. Some form of defense was needed to avoid taking dent after dent of railgun fire.

Small spacecraft made themselves as small and agile as possible while maintaining large distances to ensure that they could dodge railgun shots fired at them. Large spacecraft fitted themselves with more railguns and started using high-speed tracking and targeting systems to shoot railgun shots out of the sky with other railgun shots. 

Small and large spacecraft have defenses against each other. However with only railguns, a small ship that stays far away from the large ship can fire railgun shots at the large ship offensively, while the large ship has no hope of hitting the fighter at that distance. Large spacecraft need some sort of offensive measure against smaller ones.

In order to hit fighters far away, the large spacecraft needs a weapon whose shot moves much faster than a railgun. Ray accelerators fire hot streams of plasma at noticeable fractions of the speed of light. These shots are unable to be dodged at the same ranges as railguns, meaning it has a chance of hitting fighters when they maintain their distance.

In short, railguns are the primary weapon used by nearly every ship to engage. Larger ships and fighters can also use them defensively. Ray accelerators are included on large ships that need long range weaponry.

\newpage

\begin{multicols}{2}

\subsection{All system tables in one place}
